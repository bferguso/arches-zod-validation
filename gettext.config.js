...
module.exports = {
  input: {
    path: "./arches_zod_validation/src", // only files in this directory are considered for extraction
  ...
  output: {
    path: "./arches_zod_validation/locale", // output path of all created files
